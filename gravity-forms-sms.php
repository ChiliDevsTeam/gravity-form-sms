<?php
/**
Plugin Name: SMS Integration for Gravity Forms
Plugin URI: https://chilidevs.com
Description: Am SMS Integration plugin for Gravity Forms  helps to notify via SMS when form submitted
Version: 1.0.0
Author: chilidevs
Author URI: http://chilidevs.com/
Text Domain: gravity-forms-sms
License: GPL2
*/
